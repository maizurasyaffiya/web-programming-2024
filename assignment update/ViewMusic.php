...
{ 
    $queryView = "SELECT * FROM MUSIC WHERE status = 'approved'";
...
Click <a href="music_form.php">here</a> to enter NEW music details.  
<br><br> 
Click <a href="music_deleteView.php">here</a> to DELETE music details. 
<br><br> 
Click <a href="music_editView.php">here</a> to EDIT music details. 
<br><br>

...
{
	$queryUpdate="UPDATE MUSIC SET status='".$status."' WHERE music_id='".$music_id."'";
	
	if ($conn->query($queryUpdate) === TRUE) {
		echo "<p style = 'color:maroon;'>The status has been updated into the database. </p>";
		echo "<br><br>";
		echo "Click <a href='ViewMusicAdmin.php'> here </a> to VIEW all music details.";
	}else{
